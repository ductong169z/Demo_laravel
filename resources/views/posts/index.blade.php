...
<div class="breadcrumb" style="background-color: deepskyblue">
        <a href="{{url('/')}}" style="color: blue">Home</a>/{{$cate->name}}
                    ...
                    <div class="item film_item ">
                            <div class="film_item_inner">
                                <a href="{{url('cate'.'/'.$post->cate_id.'/'.'posts'.'/'.$post->id)}}" class="">
                                    ...
                                    <noscript><img class="thumb lazyload img-responsive" src="{{ url('storage/cover/').'/'.$post->cover}}" alt="{{$post->title}}" />
                                    </noscript>
                                    <img src="{{ url('storage/app/public/cover').'/'.$post->cover}}" data-src="{{ url('storage/app/public/cover/').'/'.$post->cover}}" class="lazyload thumb img-responsive" alt="{{$post->title}}">
                                </a>
                                <div class="mode">
